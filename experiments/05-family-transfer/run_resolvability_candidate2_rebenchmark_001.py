...
CANDIDATE2_REBENCHMARK_AUTHORIZED = False

def main():
    if not CANDIDATE2_REBENCHMARK_AUTHORIZED:raise SystemExit('STOP: synthetic benchmark is not authorized')
    ...
    output=exp/'resolvability_candidate2_rebenchmark_001_archive'
    ...
    require_closed(['run_resolvability_validation.py','run_resolvability_surface.py','run_resolvability_benchmark.py','run_resolvability_candidate2_validation.py','run_resolvability_candidate2_surface.py','run_resolvability_candidate2_benchmark.py','run_candidate2_execution_prep.py'])
