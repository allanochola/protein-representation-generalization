# ===========================================================================
# EXPERIMENT 04 — MAIN POPULATION DETERMINISTIC RECOVERY
#
# Governing recovery specification:
#   DECODER_GEOMETRY_MAIN_POPULATION_RECOVERY_SPEC.md
#   SHA-256 4be794967fae51df8f514873a4255ec5ebb0d1fff3be018358a550a3db30cb9e
#
# Exact historical computational template:
#   decoder_geometry_population_driver.py
#   SHA-256 b9d789fe73ddf12138c36544dc4d79760469f6b62c04587da90da009f0b566b5
#
# Recovery purpose:
#   Restore the previously completed biological + canonical-null
#   per-direction decoder-geometry artifact lost from ephemeral local storage.
#
...
EXPECTED_MAIN_POPULATION_RECOVERY_SPEC_SHA256 = (
    "4be794967fae51df8f514873a4255ec5ebb0d1fff3be018358a550a3db30cb9e"
)

EXPECTED_HISTORICAL_POPULATION_DRIVER_SHA256 = (
    "b9d789fe73ddf12138c36544dc4d79760469f6b62c04587da90da009f0b566b5"
)

RECOVERY_SPEC_FILENAME = (
    "DECODER_GEOMETRY_MAIN_POPULATION_RECOVERY_SPEC.md"
)

HISTORICAL_POPULATION_DRIVER_FILENAME = (
    "decoder_geometry_population_driver.py"
)


def verify_main_population_recovery_contract() -> None:
    ...
    historical_driver_path = (
        base
        / HISTORICAL_POPULATION_DRIVER_FILENAME
    )

    if not recovery_spec_path.is_file():

        raise RuntimeError(
            "Missing frozen main-population recovery specification."
        )
    ...
    if (
        ...
        raise RuntimeError(
            "Main-population recovery-spec SHA mismatch."
        )

    if not historical_driver_path.is_file():

        raise RuntimeError(
            "Missing historical population driver."
        )
    ...
    if (
        ...
        raise RuntimeError(
            "Historical population-driver SHA mismatch."
        )
...
def run_population_geometry(
    *,
    ...
    verify_main_population_recovery_contract()
